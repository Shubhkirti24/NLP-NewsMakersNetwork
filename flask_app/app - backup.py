...
def entityrec():
    if request.method == 'POST':
        ...
        # coment_df = pd.read_csv(csv_path2)
        ...
        # nx.draw(newsmakers, pos, with_labels=True, font_size=8, node_size=800, font_color='black', font_weight='bold', edge_color='gray')
        ...
        # img_path = os.path.join(app.root_path, 'static', 'network.png')
        # fig.write_image(img_path)
        # img_io = BytesIO(img_path)
        # img_data = base64.b64encode(img_io.read()).decode('utf-8')
        
        # img = pio.write_image(fig, format='png')
    ...
    # return newsmakers
    # if not result.empty:
    #     per_name = result.iloc[0]['Person']
    #     top10 = result.iloc[0]['Top 10 Related Entities']
    #     return render_template('result.html', per_name=per_name,top10=top10)
    # else:
    #     return render_template('result.html', per_name='No match found')
